  ...
  return (
    ...
    >
      <AccordionItem value="item-1">
        <AccordionTrigger>How did you make this portfolio?</AccordionTrigger>
        <AccordionContent>
          <ul>
            ...
            <li className={"opacity-50"}>Deployed to Vercel ▲.</li>
            <li className={"opacity-50"}>Components by RadixUI and Shadcn.</li>
            <li className={"mt-4 opacity-50"}>
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          ...
          <ul className="flex mt-4 flex-col gap-1.5">
            ...
            <li>
              <PriceTag pricetag="free" />
              Finding inspirations from websites like Dribbble and Mobbin
            </li>
            <li>
              <PriceTag pricetag="free" />
            ...
            <li>
              <PriceTag pricetag="free" />
              Reading the code in open source repos (Github)
            </li>
            <li>
              <PriceTag pricetag="free" />
              Youtube
      ...
      <AccordionItem value="item-3" className="border-none">
        <AccordionTrigger>
          How long have you been learning and developing?
        </AccordionTrigger>
        <AccordionContent>
          {
